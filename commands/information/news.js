...
module.exports = class extends Command {
    constructor(...args) {
      super(...args, {
        name: 'news',
        description: `Shows Colossal's latest news`,
    ...
    async run(message) {
      ...
      .setTitle(`Colossal's News`)
      .setDescription(`***__${language.datePublished}__ ${moment(guildDB.time).format("dddd, MMMM Do YYYY")}*** *__[\`(${moment(guildDB.time).fromNow()})\`](https://colossal.cf)__*\n\n ${guildDB.news}`)
