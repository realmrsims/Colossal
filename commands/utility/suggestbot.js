...
module.exports = class extends Command {
    constructor(...args) {
      super(...args, {
        name: 'suggestbot',
        aliases: [ 'botsuggest' ],
        description: `Suggest a new feature for Colossal!`,
        category: 'Utility',
...
let report = args.join(' ').split('').join('')
      ...
      .setThumbnail(message.author.displayAvatarURL({ dynamic: true }))
      .setDescription(`${language.suggest3} Support [**Server**](https://discord.gg/hjKAnBH5Qk)`)
